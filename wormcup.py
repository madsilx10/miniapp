...
_GOAL_WEIGHTS = [18, 18, 18, 18, 17, 16, 3, 1]  # 0-5 hampir rata, 6+ baru jarang
...
def decide_score(match):
    ...
    if PREDICT_MODE == "simple":
        ...
        # random - skor masuk akal, ga peduli favorit/underdog
        score = (_weighted_goal(_GOAL_WEIGHTS), _weighted_goal(_GOAL_WEIGHTS))
