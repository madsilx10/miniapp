...
# ===================== PREDICT LOGIC =====================
# Distribusi skor natural: index = jumlah gol, weight = kemungkinan
_GOAL_WEIGHTS_FAV  = [20, 35, 25, 13, 7]  # tim favorit: lebih sering 1-2 gol
_GOAL_WEIGHTS_UNDF = [35, 30, 20, 10, 5]  # tim underdog: lebih sering 0-1 gol
