...
async def get_init_data(app: Client, bot_username: str, start_param: str) -> str:
    ...
    # parse_qsl decode satu layer → hasilnya query_id=...&user=%7B...%7D&hash=...
    # Format ini yang server expect di header.
    # JANGAN inject start_param — hash Telegram udah fixed, nambah field = hash invalid = 401.
