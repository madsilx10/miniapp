...
_debug_pool_printed = False

def match_open(m):
    """Cek match UPCOMING & pool OPEN dengan aman.
    Beberapa match dari API ternyata gak punya field 'pool' sama sekali
    (kemungkinan pool belum dibuka/null), jadi dicek pelan-pelan biar gak KeyError."""
    global _debug_pool_printed
    if not _debug_pool_printed:
        print("\n[DEBUG] contoh 1 match mentah dari API:")
        print(json.dumps(m, indent=2, default=str))
        _debug_pool_printed = True
